...
class BP:
    ...
    def fwdsearch(self, i, d):
        ...
        # Here, we “lift” the block’s local min/max by computing the offset
        # as the global excess immediately before the block.
        # for k in range(block_idx+1, self._rmm.leaf_count):
    ...
    def _range_min_value(self, L, R):
        ...
        if Rb - 1 >= Lb + 1:
            ...
            if seg is not None:
                ...
                # mid_val = m_val  # the min prefix-excess in that range
